...
export function Footer({ personalInfo, socialLinks, rights }: FooterProps) {
      ...
      <div className="container-width section-padding !py-12">
        ...
        <div className="mt-8 border-t border-card-border pt-8 text-center">
          <p className="font-thai text-sm text-muted">
            &copy; {year} {personalInfo.name} — {rights.th}
          </p>
          <p className="mt-0.5 text-xs text-muted">{rights.en}</p>
        </div>
      </div>
    </footer>
  );

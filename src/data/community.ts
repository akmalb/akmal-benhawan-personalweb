export const community = {
  th: {
    section: {
      label: "งานมูลนิธิและชุมชน",
      title: "การรับผิดชอบด้านสื่อและชุมชน",
      description:
        "บทบาทในมูลนิธิเพื่อนมุสลิม นอกเหนือจากภารกิจหลักในสถาบันการศึกษา",
    },
    work: {
      role: "หัวหน้าฝ่ายสื่อ",
      organization: "มูลนิธิเพื่อนมุสลิม",
      description:
  ...
  en: {
    section: {
      ...
      title: "Media & Community Responsibilities",
      description:
        "Responsibilities with the Muslim Friends Foundation, alongside my university duties.",
    },
    work: {
